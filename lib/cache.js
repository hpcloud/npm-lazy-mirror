...
Cache.prototype.overrrideTarballUrls = function(pkg_json, cb) {
    ...
    var server_port = cache.config.https_enabled ? cache.config.https_port : cache.config.http_port;
    var protocol = cache.config.https_enabled ? 'https:' : 'http';
    ...
    var changeDistUrl = function(ver, done) {
        ...
        if (ver.dist && ver.dist.tarball) {
            ...
            dist_url.port = cache.config.real_external_port;
            dist_url.protocol = protocol;
